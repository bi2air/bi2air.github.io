...
### [Face Mask Filtration](/pages/research/face-mask-filtration.html)
...
Jupyter notebooks and Python tools for PM2.5 data from low-cost sensors.
...
| Bioreactors | [Turbidostat](/pages/turbidostat.html) control, growth simulation | Arduino, Python |
...
7 build guides. View counts below are a snapshot captured on May 16, 2026. [View profile](https://www.instructables.com/member/binova/instructables/)
...
- [GitHub (@bi2air)](https://github.com/bi2air) — repositories and source code
- [Instructables (binova)](https://www.instructables.com/member/binova/instructables/) — 7 guides, 62K+ views
- [Blog archive](/blog/) — 59 long-form posts (English + Vietnamese)

---

[Browse Research](/pages/research/){: .btn .btn-primary .fs-5 .mb-4 .mb-md-0 .mr-2 }
