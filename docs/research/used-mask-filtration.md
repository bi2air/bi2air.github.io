...
{: .note }
Follow-up to the [face mask filtration study](/docs/research/face-mask-filtration.html). Used masks retain 74% removal efficiency; washed masks achieve 82%. Both are acceptable alternatives to disposal after single use.
...
- **Setup:** Identical to the [original mask study](/docs/research/face-mask-filtration.html) — two PMS7003 sensors (background and filtered), mask mounted on PVC pipe with variable-speed fan
