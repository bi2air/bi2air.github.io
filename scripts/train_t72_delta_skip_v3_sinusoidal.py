...
TIME_COLS = ['sin_hour', 'cos_hour', 'sin_month', 'cos_month', 'sin_dow', 'cos_dow', 'sin_season', 'cos_season']
...
def prep_data_sinusoidal():
    print("Loading and preparing Sinusoidal data...")
...
def train():
    X_train, y_train, X_valid, y_valid, c_train, c_valid, scaler_x = prep_data_sinusoidal()
    ...
    best_loss = float('inf')
    best_model_path = f'{MODELS_DIR}/t72_delta_skip_sinusoidal_best.pt'
    ...
    # Save Sinusoidal results
    with open('docs/results_v3_sinusoidal.pkl', 'wb') as f:
