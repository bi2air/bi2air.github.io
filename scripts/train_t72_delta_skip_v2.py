...
# --- MODEL ---
class DeltaSkipMLPV2(nn.Module):
    def __init__(self, input_dim, output_dim):
        super(DeltaSkipMLPV2, self).__init__()
...
def prep_data_v2():
    print("Loading and preparing V2 data...")
...
def train():
    X_train, y_train, X_valid, y_valid, c_train, c_valid, scaler_x = prep_data_v2()
    ...
    model = DeltaSkipMLPV2(X_train.shape[1], MAX_HORIZON).to(device)
    ...
    best_loss = float('inf')
    best_model_path = f'{MODELS_DIR}/t72_delta_skip_v2_best.pt'
    ...
    # Save V2 results
    with open('doc-work/results_v2_features.pkl', 'wb') as f:
