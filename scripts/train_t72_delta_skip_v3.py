...
def train():
    X_train, y_train, X_valid, y_valid, c_train, c_valid, scaler_x = prep_data_v3()
    ...
    best_loss = float('inf')
    best_model_path = f'{MODELS_DIR}/t72_delta_skip_v3_best.pt'
    ...
    # Save V3 results
    with open('doc-work/results_v3_features.pkl', 'wb') as f:
