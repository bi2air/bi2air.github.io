...
In the [previous study](/pages/research/face-mask-filtration.html), new particulate respirator masks (AQBlue, Airphin) achieved ~90% PM$\_{2.5}$ removal efficiency (RE). However, at 35-50k VND per mask (USUSD 1.50-2.20), weekly replacement is expensive for low-to-medium income commuters.
