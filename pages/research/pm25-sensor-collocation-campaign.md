---
layout: default
title: PM2.5 Sensor Collocation Campaign
parent: "2022"
...
The earlier [Low-Cost PM$\_{2.5}$ Sensors](/pages/research/pm25-low-cost-sensors.html) page is the better place for the strict **reference-station calibration** story. That page compares PMS7003 and SDS011 directly with the **US Embassy Hanoi MetOne BAM-1020** over about 60 days.
...
- [Low-Cost PM$\_{2.5}$ Sensors](/pages/research/pm25-low-cost-sensors.html) — BAM-based calibration of PMS7003 and SDS011
- [AQI Calculation Guide](/pages/research/aqi-calculation-guide.html) — AQI breakpoints and PM$\_{2.5}$ conversion context
