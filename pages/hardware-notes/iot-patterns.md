...
|------|------|--------------|---------|
| PVC pipe segments | USD 2-5 | Good (sealed) | Moderate |
| 3D-printed | USD 5-15 | Fair (needs sealing) | Poor (PLA warps) |
| Project box (ABS) | USD 5-10 | Good | Fair |
| Aluminum foil wrap | USD 0 | No | Excellent light shielding |
...
2. **Duplicate sensors are cheap insurance** — a USD 3 extra DHT22 saves hours of debugging drift
