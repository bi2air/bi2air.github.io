...
*Range of instruments: research-grade stationary monitors to USD 13 laser-scattering sensors.*
...
| My projects | PMS7003, SDS011 | Laser scattering | [See study](/pages/research/pm25-low-cost-sensors.html) |

### Low-Cost Sensors

| Sensor | Price | Output | Lifespan | Notes |
|--------|-------|--------|----------|-------|
| PMS7003 (Plantower) | ~USD 13 | PM1/2.5/10 + 6 size bins | 8,000h | Best value, small, rich data |
| SDS011 (Nova Fitness) | ~USD 19 | PM$\_{2.5}$, PM$\_{10}$ (float) | 8,000h | Remote air intake via hose |
| HPMA115S0 (Honeywell) | ~USD 19 | PM$\_{2.5}$, PM$\_{10}$ (int) | 20,000h | Best documentation |
| Dylos DC1100 Pro | ~USD 290 | Particle count (2 bins) | Years | Reference for hobbyists |
